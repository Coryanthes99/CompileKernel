...
LATEST_COMMIT="[$COMMIT_POINT](https://github.com/Zombie-Prjkt/kernel_xiaomi_surya-1/commit/$CHEAD)"
LOGS_URL="[See Circle CI Build Logs Here](https://circleci.com/gh/Zombie-Prjkt/kernel_xiaomi_surya-1/$CIRCLE_BUILD_NUM)"
...
makekernel() {
    ...
    echo "fakeriz@Umbrella" > "$KERNEL_DIR"/.builderdata
